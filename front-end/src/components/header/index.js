        ...
        <header>
            ...
            <nav className="nav_bar">
                ...
                <div className="botoes_header">
                    ...
                    <div className="configuracoes_button">
                        <button className="button_header" onClick={() => navigateTo('/login/criar-conta')}>Cadastrar</button>
                    </div>
            ...
            <div className="mobile_menu">
                ...
                <div className="botoes_header">
                    ...
                    <div className="login_button">
                        <button className="button_header" onClick={() => navigateTo('/login/login')}>lalala</button>
                    </div>
