    ...
    return (
        ...
        <nav className="nav_bar">
            ...
            <div className="nav_list">
                <ul>
                    <li className="nav_item"><a href="../pages/home" className="nav_link">Página Inicial</a></li>
                    <li className="nav_item"><a href="../pages/acoes" className="nav_link">Sou voluntário</a></li>
                    <li className="nav_item"><a href="../pages/ongs" className="nav_link">Sou ONG</a></li>
                    <li className="nav_item"><a href="../pages/pontos-coleta" className="nav_link">Pontos de Coleta</a></li>
