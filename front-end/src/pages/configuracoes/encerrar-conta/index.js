        ...
        <section className="seccao">
            ...
            <div className="a">
                ...
                <div className="c">
                    ...
                    <h4> Se você encerrar sua conta, terá a inscrição cancelada em todos os trabalhos voluntários e perderá acesso à sua conta e todos os dados associados a ela para sempre, mesmo se você criar uma nova conta usando o mesmo endereço de e-mail no futuro. </h4>
